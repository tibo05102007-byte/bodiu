...
const bestsellers = [
  {
    ...
    category: 'APOLLO',
    image: '/images/products/РУЧКИ/APOLLO/серебро APOLLO/IMG_0203.JPG',
    badge: 'Бестселлер',
  ...
  },
  {
    ...
    category: 'Статус',
    image: '/images/products/РУЧКИ/Статус/Золото Статус/IMG_2038.JPG',
    badge: 'Акция',
  ...
  },
  {
    ...
    category: 'Цилиндры',
    image: '/images/products/СЕРДЕЦЕВИНЫ/IMG_1361.JPG',
    badge: null,
    badgeColor: '',
    rating: 4.9,
    reviews: 94,
